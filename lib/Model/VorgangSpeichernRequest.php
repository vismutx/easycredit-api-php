...
/**
 * VorgangSpeichernRequest Class Doc Comment
 *
 * @category Class
 * @description transaction saving Request data
 * @package  Vismutx\EasycreditApiPhp
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VorgangSpeichernRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VorgangSpeichernRequest';
    ...
    protected static $swaggerTypes = [
        'vorgang_speichern_input' => '\Vismutx\EasycreditApiPhp\Model\VorgangSpeichernInput'
    ];
    ...
    protected static $attributeMap = [
        'vorgang_speichern_input' => 'vorgangSpeichernInput'
    ];
    ...
    protected static $setters = [
        'vorgang_speichern_input' => 'setVorgangSpeichernInput'
    ];
    ...
    protected static $getters = [
        'vorgang_speichern_input' => 'getVorgangSpeichernInput'
    ];
    ...
    {
        $this->container['vorgang_speichern_input'] = isset($data['vorgang_speichern_input']) ? $data['vorgang_speichern_input'] : null;
    }
    ...
    /**
     * Gets vorgang_speichern_input
     *
     * @return \Vismutx\EasycreditApiPhp\Model\VorgangSpeichernInput
     */
    public function getVorgangSpeichernInput()
    {
        return $this->container['vorgang_speichern_input'];
    }

    /**
     * Sets vorgang_speichern_input
     *
     * @param \Vismutx\EasycreditApiPhp\Model\VorgangSpeichernInput $vorgang_speichern_input vorgang_speichern_input
     *
     * @return $this
     */
    public function setVorgangSpeichernInput($vorgang_speichern_input)
    {
        $this->container['vorgang_speichern_input'] = $vorgang_speichern_input;
