...
/**
 * Finanzierung Class Doc Comment
 *
 * @category Class
 * @package  Vismutx\EasycreditApiPhp
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Finanzierung implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Finanzierung';
     ...
     * Sets laufzeit
     *
     * @param int $laufzeit Term in months
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getLaufzeitAllowableValues();
        if (!is_null($laufzeit) && !in_array($laufzeit, $allowedValues, true)) {
