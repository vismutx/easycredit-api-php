...
/**
 * TexteResponse Class Doc Comment
 *
 * @category Class
 * @package  Vismutx\EasycreditApiPhp
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TexteResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TexteResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'timestamp' => 'int',
        'repraesentatives_beispiel' => 'string',
        'produktangaben' => 'string'
    ];
    ...
    protected static $swaggerFormats = [
        ...
        'webshopkennung' => null,
        'timestamp' => 'int64',
        'repraesentatives_beispiel' => null,
        'produktangaben' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'timestamp' => 'timestamp',
        'repraesentatives_beispiel' => 'repraesentativesBeispiel',
    ...
    protected static $setters = [
        ...
        'repraesentatives_beispiel' => 'setRepraesentativesBeispiel',
        'produktangaben' => 'setProduktangaben'
    ];
    ...
    protected static $getters = [
        ...
        'repraesentatives_beispiel' => 'getRepraesentativesBeispiel',
        'produktangaben' => 'getProduktangaben'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['repraesentatives_beispiel'] = isset($data['repraesentatives_beispiel']) ? $data['repraesentatives_beispiel'] : null;
        $this->container['produktangaben'] = isset($data['produktangaben']) ? $data['produktangaben'] : null;
    }
    ...
    /**
     * Gets repraesentatives_beispiel
     *
     * @return string
     */
    public function getRepraesentativesBeispiel()
    {
        return $this->container['repraesentatives_beispiel'];
    }

    /**
     * Sets repraesentatives_beispiel
     *
     * @param string $repraesentatives_beispiel repraesentatives_beispiel
     *
     * @return $this
     */
    public function setRepraesentativesBeispiel($repraesentatives_beispiel)
    {
        $this->container['repraesentatives_beispiel'] = $repraesentatives_beispiel;
     ...
     * @return string
     */
    public function getProduktangaben()
    {
        return $this->container['produktangaben'];
    }

    /**
     * Sets produktangaben
     *
     * @param string $produktangaben produktangaben
     *
     * @return $this
     */
    public function setProduktangaben($produktangaben)
    {
        $this->container['produktangaben'] = $produktangaben;
