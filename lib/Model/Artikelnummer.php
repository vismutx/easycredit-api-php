...
/**
 * Artikelnummer Class Doc Comment
 *
 * @category Class
 * @description An article number always consists of an alphanumeric number and a type such as GTIN or EAN.
 * @package  Vismutx\EasycreditApiPhp
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Artikelnummer implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Artikelnummer';
    ...
    {
        $this->container['nummerntyp'] = isset($data['nummerntyp']) ? $data['nummerntyp'] : null;
        $this->container['nummer'] = isset($data['nummer']) ? $data['nummer'] : null;
    }
     ...
     * @return string
     */
    public function getNummerntyp()
    {
        return $this->container['nummerntyp'];
    }

    /**
     * Sets nummerntyp
     *
     * @param string $nummerntyp nummerntyp
     *
     * @return $this
     */
    public function setNummerntyp($nummerntyp)
    {
        $this->container['nummerntyp'] = $nummerntyp;
