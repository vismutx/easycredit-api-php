...
/**
 * BankverbindungKtoBlz Class Doc Comment
 *
 * @category Class
 * @package  Vismutx\EasycreditApiPhp
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BankverbindungKtoBlz implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BankverbindungKtoBlz';
    ...
    {
        $this->container['kto_nr'] = isset($data['kto_nr']) ? $data['kto_nr'] : null;
    ...
    {
        return $this->container['kto_nr'];
    }

    /**
     * Sets kto_nr
     *
     * @param string $kto_nr MMust only be specified if no IBAN is provided.
     *
     * @return $this
     */
    public function setKtoNr($kto_nr)
    {
        $this->container['kto_nr'] = $kto_nr;
     ...
     * Sets blz
     *
     * @param string $blz Must only be specified if no IBAN is provided.
     *
     * @return $this
     */
